...
import com.nazmi.kasapp14.helper.CurrentDate;
import com.nazmi.kasapp14.helper.SqliteHelper;
...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = database.rawQuery(
                "SELECT *,  strftime('%d/%m/%Y', tanggal) AS tgl FROM transaksi WHERE transaksi_id = '"+ MainActivity.transaksi_id+ "'", null);
        cursor.moveToFirst();
        ...
        edit_jumlah.setText(cursor.getString(1));
        ...
        edit_tanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                datePickerDialog = new DatePickerDialog(EditActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month_of_years, int day_of_mounth) {
                        NumberFormat numberFormat = new DecimalFormat("00");
                        tanggal = year + "-" + numberFormat.format((month_of_years + 1)) + "-" + numberFormat.format(day_of_mounth);
                        edit_tanggal.setText(numberFormat.format(day_of_mounth) + "/" + numberFormat.format((month_of_years + 1)) + "/" + year);
                    }
